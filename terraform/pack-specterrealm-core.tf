# SpecterRealm Core — shared NeoForge library mod for all Colony Protocol packs.
# Copy this file pattern when onboarding another non-pack SpecterRealm repo.

locals {
  pack_settings_specterrealm_core = {
